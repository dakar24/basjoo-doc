...
// Source file: ///home/admin/protobuf/src/f64a4824fe6ff47bdacd0e36ca0abcfd/proto/Password
 ...
 * 修改密码结果
 */
public final class ChangePasswordResult extends Message {
  ...
  public ChangePasswordResult(ChangePasswordResult message) {
    super(message);
  ...
  public ChangePasswordResult fillTagValue(int tag, Object value) {
    switch(tag) {
        case TAG_RESULTCODE:
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof ChangePasswordResult)) return false;
    ChangePasswordResult o = (ChangePasswordResult) other;
