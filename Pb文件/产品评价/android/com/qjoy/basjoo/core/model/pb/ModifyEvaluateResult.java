 ...
 * 修改评价结果
 */
public final class ModifyEvaluateResult extends Message {
  ...
  public ModifyEvaluateResult(ModifyEvaluateResult message) {
    super(message);
  ...
  public ModifyEvaluateResult() {
  }

  public ModifyEvaluateResult fillTagValue(int tag, Object value) {
    switch(tag) {
        case TAG_RESULTCODE:
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof ModifyEvaluateResult)) return false;
    ModifyEvaluateResult o = (ModifyEvaluateResult) other;
