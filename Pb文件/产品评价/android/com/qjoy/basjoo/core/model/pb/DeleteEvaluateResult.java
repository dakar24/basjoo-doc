 ...
 * 删除评价结果
 */
public final class DeleteEvaluateResult extends Message {
  ...
  public DeleteEvaluateResult(DeleteEvaluateResult message) {
    super(message);
  ...
  public DeleteEvaluateResult() {
  }

  public DeleteEvaluateResult fillTagValue(int tag, Object value) {
    switch(tag) {
        case TAG_RESULTCODE:
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof DeleteEvaluateResult)) return false;
    DeleteEvaluateResult o = (DeleteEvaluateResult) other;
