 ...
 * 产品详情
 */
public final class ProductDetailResult extends Message {

  public static final int TAG_RESULTCODE = 1;
  public static final int TAG_RESULTMSG = 2;
  public static final int TAG_PRODUCTDETAILINFO = 3;
  ...
  public ProductDetailResult(ProductDetailResult message) {
    super(message);
    if (message == null) return;
    this.resultCode = message.resultCode;
    this.resultMsg = message.resultMsg;
    this.productDetailInfo = message.productDetailInfo;
  }

  public ProductDetailResult() {
  }

  public ProductDetailResult fillTagValue(int tag, Object value) {
    switch(tag) {
        case TAG_RESULTCODE:
        ...
        break;
        case TAG_PRODUCTDETAILINFO:
        this.productDetailInfo = (ProductDetailInfo)value;
        break;
        default: break;
        };
    return this;
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof ProductDetailResult)) return false;
    ProductDetailResult o = (ProductDetailResult) other;
    return equals(resultCode, o.resultCode)
        && equals(resultMsg, o.resultMsg)
        && equals(productDetailInfo, o.productDetailInfo);
  }
  ...
  public int hashCode() {
    ...
    if (result == 0) {
      ...
      result = result * 37 + (productDetailInfo != null ? productDetailInfo.hashCode() : 0);
      hashCode = result;
    }
    return result;
  }
