...
@interface SearchProductListRequest : APPBGeneratedMessage<GeneratedMessageProtocol>
...
@interface SearchProductListResult : APPBGeneratedMessage<GeneratedMessageProtocol>
...
@interface ProductLiteInfo : APPBGeneratedMessage<GeneratedMessageProtocol>
...
@interface ProductDetailRequest : APPBGeneratedMessage<GeneratedMessageProtocol>
@property (readonly) BOOL hasProductId;
@property (nonatomic,strong) NSString* productId;
@end

@interface ProductDetailResult : APPBGeneratedMessage<GeneratedMessageProtocol>
@property (readonly) BOOL hasResultCode;
@property (readonly) BOOL hasResultMsg;
...
@interface ProductDetailInfo : APPBGeneratedMessage<GeneratedMessageProtocol>
@property (readonly) BOOL hasProductId;
@property (readonly) BOOL hasProductType;
@property (readonly) BOOL hasBrand;
@property (readonly) BOOL hasDesc;
...
@interface ColorInfo : APPBGeneratedMessage<GeneratedMessageProtocol>
...
@interface RentInfo : APPBGeneratedMessage<GeneratedMessageProtocol>
