 ...
 * 提交意见结果
 */
public final class CommitFeedbackResult extends Message {
  ...
  public CommitFeedbackResult(CommitFeedbackResult message) {
    super(message);
  ...
  public CommitFeedbackResult() {
  }

  public CommitFeedbackResult fillTagValue(int tag, Object value) {
    switch(tag) {
        case TAG_RESULTCODE:
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof CommitFeedbackResult)) return false;
    CommitFeedbackResult o = (CommitFeedbackResult) other;
