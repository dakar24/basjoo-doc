 ...
 * 参团用户的默认收货地址
 */
public final class GroupProductReceiveAddress extends Message {
  ...
  public GroupProductReceiveAddress(GroupProductReceiveAddress message) {
    super(message);
  ...
  public GroupProductReceiveAddress() {
  }

  public GroupProductReceiveAddress fillTagValue(int tag, Object value) {
    switch(tag) {
        case TAG_RECEIVER:
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof GroupProductReceiveAddress)) return false;
    GroupProductReceiveAddress o = (GroupProductReceiveAddress) other;
