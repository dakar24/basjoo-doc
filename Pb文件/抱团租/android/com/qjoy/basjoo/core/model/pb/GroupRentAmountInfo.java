 ...
 */
public final class GroupRentAmountInfo extends Message {
  ...
  public GroupRentAmountInfo(GroupRentAmountInfo message) {
    super(message);
  ...
  public GroupRentAmountInfo() {
  }

  public GroupRentAmountInfo fillTagValue(int tag, Object value) {
    switch(tag) {
        case TAG_CODEKEY:
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof GroupRentAmountInfo)) return false;
    GroupRentAmountInfo o = (GroupRentAmountInfo) other;
