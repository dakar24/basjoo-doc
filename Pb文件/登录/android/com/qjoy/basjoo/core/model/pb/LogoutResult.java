 ...
 * 登出结果
 */
public final class LogoutResult extends Message {
  ...
  public LogoutResult(LogoutResult message) {
    super(message);
  ...
  public LogoutResult fillTagValue(int tag, Object value) {
    switch(tag) {
        case TAG_RESULTCODE:
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof LogoutResult)) return false;
    LogoutResult o = (LogoutResult) other;
