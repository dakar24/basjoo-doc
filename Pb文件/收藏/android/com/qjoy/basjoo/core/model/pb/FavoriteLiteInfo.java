 ...
 * 收藏简要信息
 */
public final class FavoriteLiteInfo extends Message {
  ...
  public FavoriteLiteInfo() {
  }

  public FavoriteLiteInfo fillTagValue(int tag, Object value) {
    switch(tag) {
        case TAG_PRODUCTID:
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof FavoriteLiteInfo)) return false;
    FavoriteLiteInfo o = (FavoriteLiteInfo) other;
