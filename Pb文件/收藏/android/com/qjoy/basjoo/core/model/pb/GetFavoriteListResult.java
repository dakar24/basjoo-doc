 ...
 * 获取收藏（产品）结果
 */
public final class GetFavoriteListResult extends Message {
  ...
  public static final int TAG_FAVORITELITEINFO = 5;
  ...
  public static final List<FavoriteLiteInfo> DEFAULT_FAVORITELITEINFO = Collections.emptyList();
  ...
  public List<FavoriteLiteInfo> favoriteLiteInfo;

  public GetFavoriteListResult(GetFavoriteListResult message) {
    super(message);
    ...
    this.favoriteLiteInfo = copyOf(message.favoriteLiteInfo);
  }

  public GetFavoriteListResult() {
  }

  public GetFavoriteListResult fillTagValue(int tag, Object value) {
    switch(tag) {
        case TAG_RESULTCODE:
        ...
        break;
        case TAG_FAVORITELITEINFO:
        this.favoriteLiteInfo = immutableCopyOf((List<FavoriteLiteInfo>)value);
        break;
        default: break;
        };
    return this;
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof GetFavoriteListResult)) return false;
    GetFavoriteListResult o = (GetFavoriteListResult) other;
    return equals(resultCode, o.resultCode)
        && equals(resultMsg, o.resultMsg)
        && equals(maxIndex, o.maxIndex)
        && equals(hasMore, o.hasMore)
        && equals(favoriteLiteInfo, o.favoriteLiteInfo);
  }
  ...
  public int hashCode() {
    ...
    if (result == 0) {
      ...
      result = result * 37 + (favoriteLiteInfo != null ? favoriteLiteInfo.hashCode() : 1);
      hashCode = result;
    }
    return result;
  }
