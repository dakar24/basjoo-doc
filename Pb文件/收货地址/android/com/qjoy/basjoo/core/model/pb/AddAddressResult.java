 ...
 * 添加收货结果
 */
public final class AddAddressResult extends Message {
  ...
  public AddAddressResult(AddAddressResult message) {
    super(message);
  ...
  public AddAddressResult fillTagValue(int tag, Object value) {
    switch(tag) {
        case TAG_RESULTCODE:
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof AddAddressResult)) return false;
    AddAddressResult o = (AddAddressResult) other;
