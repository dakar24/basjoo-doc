 ...
 * 修改收货地址请求
 */
public final class ModifyAddressRequest extends Message {
  ...
  public ModifyAddressRequest fillTagValue(int tag, Object value) {
    switch(tag) {
        case TAG_RECEIVER:
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof ModifyAddressRequest)) return false;
    ModifyAddressRequest o = (ModifyAddressRequest) other;
