 ...
 * 收货地址详细信息
 */
public final class AddressDetailInfo extends Message {
  ...
  public AddressDetailInfo fillTagValue(int tag, Object value) {
    switch(tag) {
        case TAG_RECEIVER:
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof AddressDetailInfo)) return false;
    AddressDetailInfo o = (AddressDetailInfo) other;
