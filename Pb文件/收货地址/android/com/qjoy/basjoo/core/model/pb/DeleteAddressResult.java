 ...
 * 删除收货地址结果
 */
public final class DeleteAddressResult extends Message {
  ...
  public DeleteAddressResult(DeleteAddressResult message) {
    super(message);
  ...
  public DeleteAddressResult fillTagValue(int tag, Object value) {
    switch(tag) {
        case TAG_RESULTCODE:
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof DeleteAddressResult)) return false;
    DeleteAddressResult o = (DeleteAddressResult) other;
