 ...
 * 修改头像结果
 */
public final class ChangeHeadIconResult extends Message {
  ...
  public ChangeHeadIconResult(ChangeHeadIconResult message) {
    super(message);
  ...
  public ChangeHeadIconResult() {
  }

  public ChangeHeadIconResult fillTagValue(int tag, Object value) {
    switch(tag) {
        case TAG_RESULTCODE:
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof ChangeHeadIconResult)) return false;
    ChangeHeadIconResult o = (ChangeHeadIconResult) other;
