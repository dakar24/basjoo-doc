 ...
 * 重置密码结果
 */
public final class ResetPasswordResult extends Message {
  ...
  public ResetPasswordResult(ResetPasswordResult message) {
    super(message);
  ...
  public ResetPasswordResult fillTagValue(int tag, Object value) {
    switch(tag) {
        case TAG_RESULTCODE:
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof ResetPasswordResult)) return false;
    ResetPasswordResult o = (ResetPasswordResult) other;
