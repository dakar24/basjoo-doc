 ...
 * 修改手机号结果
 */
public final class ChangeMobileNoResult extends Message {
  ...
  public ChangeMobileNoResult(ChangeMobileNoResult message) {
    super(message);
  ...
  public ChangeMobileNoResult() {
  }

  public ChangeMobileNoResult fillTagValue(int tag, Object value) {
    switch(tag) {
        case TAG_RESULTCODE:
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof ChangeMobileNoResult)) return false;
    ChangeMobileNoResult o = (ChangeMobileNoResult) other;
