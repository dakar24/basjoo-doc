 ...
 * 标记通知为已读结果
 */
public final class MarkNotifyReadedResult extends Message {
  ...
  public MarkNotifyReadedResult(MarkNotifyReadedResult message) {
    super(message);
  ...
  public MarkNotifyReadedResult() {
  }

  public MarkNotifyReadedResult fillTagValue(int tag, Object value) {
    switch(tag) {
        case TAG_RESULTCODE:
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof MarkNotifyReadedResult)) return false;
    MarkNotifyReadedResult o = (MarkNotifyReadedResult) other;
