 ...
 * 获取通知列表
 */
public final class GetNotifyLiteInfoListResult extends Message {
  ...
  public GetNotifyLiteInfoListResult(GetNotifyLiteInfoListResult message) {
    super(message);
  ...
  public GetNotifyLiteInfoListResult() {
  }

  public GetNotifyLiteInfoListResult fillTagValue(int tag, Object value) {
    switch(tag) {
        case TAG_RESULTCODE:
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof GetNotifyLiteInfoListResult)) return false;
    GetNotifyLiteInfoListResult o = (GetNotifyLiteInfoListResult) other;
