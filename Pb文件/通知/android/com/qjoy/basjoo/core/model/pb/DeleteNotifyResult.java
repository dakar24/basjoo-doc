 ...
 * 删除消息通知
 */
public final class DeleteNotifyResult extends Message {
  ...
  public DeleteNotifyResult(DeleteNotifyResult message) {
    super(message);
  ...
  public DeleteNotifyResult() {
  }

  public DeleteNotifyResult fillTagValue(int tag, Object value) {
    switch(tag) {
        case TAG_RESULTCODE:
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof DeleteNotifyResult)) return false;
    DeleteNotifyResult o = (DeleteNotifyResult) other;
