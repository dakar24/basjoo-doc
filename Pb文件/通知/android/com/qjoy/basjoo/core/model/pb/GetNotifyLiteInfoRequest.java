 ...
 * 获取通知列表
 */
public final class GetNotifyLiteInfoRequest extends Message {
  ...
  public GetNotifyLiteInfoRequest(GetNotifyLiteInfoRequest message) {
    super(message);
  ...
  public GetNotifyLiteInfoRequest() {
  }

  public GetNotifyLiteInfoRequest fillTagValue(int tag, Object value) {
    switch(tag) {
        case TAG_NOTIFYTYPE:
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof GetNotifyLiteInfoRequest)) return false;
    GetNotifyLiteInfoRequest o = (GetNotifyLiteInfoRequest) other;
