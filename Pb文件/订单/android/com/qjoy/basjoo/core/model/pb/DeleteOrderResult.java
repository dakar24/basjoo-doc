 ...
 * 删除订单结果
 */
public final class DeleteOrderResult extends Message {
  ...
  public DeleteOrderResult(DeleteOrderResult message) {
    super(message);
  ...
  public DeleteOrderResult fillTagValue(int tag, Object value) {
    switch(tag) {
        case TAG_RESULTCODE:
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof DeleteOrderResult)) return false;
    DeleteOrderResult o = (DeleteOrderResult) other;
