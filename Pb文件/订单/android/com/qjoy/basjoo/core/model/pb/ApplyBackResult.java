 ...
 * 申请归还结果
 */
public final class ApplyBackResult extends Message {
  ...
  public ApplyBackResult(ApplyBackResult message) {
    super(message);
  ...
  public ApplyBackResult() {
  }

  public ApplyBackResult fillTagValue(int tag, Object value) {
    switch(tag) {
        case TAG_RESULTCODE:
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof ApplyBackResult)) return false;
    ApplyBackResult o = (ApplyBackResult) other;
