 ...
 * 确认订单结果
 */
public final class ConfirmEarnestResult extends Message {
  ...
  public ConfirmEarnestResult(ConfirmEarnestResult message) {
    super(message);
  ...
  public ConfirmEarnestResult() {
  }

  public ConfirmEarnestResult fillTagValue(int tag, Object value) {
    switch(tag) {
        case TAG_RESULTCODE:
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof ConfirmEarnestResult)) return false;
    ConfirmEarnestResult o = (ConfirmEarnestResult) other;
