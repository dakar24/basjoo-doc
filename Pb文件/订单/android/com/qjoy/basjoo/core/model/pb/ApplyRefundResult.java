 ...
 * 申请退款结果
 */
public final class ApplyRefundResult extends Message {
  ...
  public ApplyRefundResult(ApplyRefundResult message) {
    super(message);
  ...
  public ApplyRefundResult fillTagValue(int tag, Object value) {
    switch(tag) {
        case TAG_RESULTCODE:
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof ApplyRefundResult)) return false;
    ApplyRefundResult o = (ApplyRefundResult) other;
