 ...
 * 注册推荐码结果
 */
public final class RegisterRecommendCodeResult extends Message {
  ...
  public RegisterRecommendCodeResult(RegisterRecommendCodeResult message) {
    super(message);
  ...
  public RegisterRecommendCodeResult() {
  }

  public RegisterRecommendCodeResult fillTagValue(int tag, Object value) {
    switch(tag) {
        case TAG_RESULTCODE:
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof RegisterRecommendCodeResult)) return false;
    RegisterRecommendCodeResult o = (RegisterRecommendCodeResult) other;
